...
async function main() {
  ...
  const groupData = [
    ...
    { name: "Donation & Sponsorship", nature: Nature.INCOME, isSystem: false },
  ];
  ...
  const ledgerData = [
    ...
    // Membership Income — individual member ledgers are auto-created here
    // Other Income
    ...
    { code: "5205", name: "Event Expenses", groupName: "Operational", isSystem: false, openingType: DrCr.DR, description: "Expenses for tournaments and events" },
    // Other Expenses
