...
import { updateJournal } from "@/app/actions/accounting"
...
export function EditJournalForm({
    ...
    async function onSubmit(data: JournalInput) {
        ...
        setIsLoading(true)
        try {
            const result = await updateJournal(transactionId, data)
            if (result.error) {
                toast.error(result.error)
            } else {
                toast.success("Journal entry updated")
                router.push("/admin/accounting/journal?tab=all")
                router.refresh()
            }
        } catch {
            ...
            <CardHeader>
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <CardDescription>Update multi-line journal adjustments.</CardDescription>
                    </div>
                </div>
            </CardHeader>
            <CardContent>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="flex justify-end gap-3 pt-2">
                            ...
                            <Button type="submit" className="bg-sky-600 hover:bg-sky-700" disabled={isLoading || !isBalanced}>
